      ...
      <div className={style.modalContainer}>
        <div className={style.modalHeader}>
          ...
          <div className={style.closeButton}>
            <button 
              onClick={() => {closeModal(false); setRecipeInfo(false); setSavedStatus(false);}}
            >
                x
            </button>
          </div>
          ...
          <div className={style.rightWrapper}>
            ...
            <div className={style.midFlex}>
              <div>
                ...
                <p>{recipeObj.missedIngredientCount}</p>
              </div>
              <div className={style.Missing}>
                <h4>Missing Ingredient/s:</h4>
                {recipeObj.missedIngredients.map((ingredient, index) => 
